      ...
      <div className="container">
        <div className="about-us-heading">
          ...
          <div className="aboutus-logo-container">
            ...
            <h1 className="aboutus-logo-text">SilverScreen</h1>
          </div>
        </div>
        <div className="about-us-body">
          <p>Welcome to SilverScreen,</p>
          <p>
            At SilverScreen, we are passionate about delivering the ultimate
          ...
          <p>
            Join us at SilverScreen and immerse yourself in the captivating world
