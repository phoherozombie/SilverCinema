...
const AboutUsSection = () => {
  return (
    <>
      <Head>
        <title>About Us - ASHO DEKHI</title>
        <meta name="description" content="Discover the story behind ASHO DEKHI, where we create unforgettable cinematic experiences with state-of-the-art technology and premium services." />
      </Head>
      <section className="py-20 bg-gray-900 text-white">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-10">
            <h1 className="text-4xl font-bold mb-4">Unveiling Our Story Behind</h1>
            <div className="flex flex-col items-center">
              ...
              <h2 className="text-2xl font-bold">Asho Dekhi</h2>
            </div>
          </div>
